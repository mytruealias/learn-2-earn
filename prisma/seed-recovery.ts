...
async function main() {
  ...
  const l6_1_1 = await upsertLesson({ moduleId: unit6_1.id, title: "Addiction 101 (Without Shame)", slug: "addiction-101", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_1_2 = await upsertLesson({ moduleId: unit6_1.id, title: "The Brain and Cravings", slug: "brain-and-cravings", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_1_3 = await upsertLesson({ moduleId: unit6_1.id, title: "Stages of Change", slug: "stages-of-change", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_1_4 = await upsertLesson({ moduleId: unit6_1.id, title: "Ambivalence (Wanting Two Things)", slug: "ambivalence", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_1_5 = await upsertLesson({ moduleId: unit6_1.id, title: "Goals That Fit Real Life", slug: "goals-fit-real-life", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_2_1 = await upsertLesson({ moduleId: unit6_2.id, title: "Your Triggers (People, Places, Feelings)", slug: "your-triggers", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_2_2 = await upsertLesson({ moduleId: unit6_2.id, title: "HALT Check (Hungry, Angry, Lonely, Tired)", slug: "halt-check", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_2_3 = await upsertLesson({ moduleId: unit6_2.id, title: "Emotions and Use", slug: "emotions-and-use", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_2_4 = await upsertLesson({ moduleId: unit6_2.id, title: "The Cost of Use (Money, Time, Relationships)", slug: "cost-of-use", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_2_5 = await upsertLesson({ moduleId: unit6_2.id, title: "Your Strengths Inventory", slug: "strengths-inventory", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_3_1 = await upsertLesson({ moduleId: unit6_3.id, title: "Urge Surfing", slug: "urge-surfing", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_3_2 = await upsertLesson({ moduleId: unit6_3.id, title: "Delay and Distract", slug: "delay-and-distract", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_3_3 = await upsertLesson({ moduleId: unit6_3.id, title: "Thought Traps", slug: "thought-traps", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_3_4 = await upsertLesson({ moduleId: unit6_3.id, title: "Grounding and Reset", slug: "grounding-reset", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_3_5 = await upsertLesson({ moduleId: unit6_3.id, title: "Sleep and Recovery", slug: "sleep-and-recovery", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_4_1 = await upsertLesson({ moduleId: unit6_4.id, title: "Your Recovery Why", slug: "recovery-why", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_4_2 = await upsertLesson({ moduleId: unit6_4.id, title: "Your Support Team", slug: "support-team", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_4_3 = await upsertLesson({ moduleId: unit6_4.id, title: "High-Risk Situations Plan", slug: "high-risk-plan", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_4_4 = await upsertLesson({ moduleId: unit6_4.id, title: "Boundaries Basics", slug: "boundaries-basics-recovery", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l6_4_5 = await upsertLesson({ moduleId: unit6_4.id, title: "Progress Tracking Without Shame", slug: "progress-tracking", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit6_cap = await upsertModule({ pathId: journey6.id, title: "Recovery Foundations Capstone", slug: "recovery-foundations-capstone", order: 5 });
  const j6_capstone = await upsertLesson({ moduleId: unit6_cap.id, title: "Recovery Foundations: Final Challenge", slug: "recovery-foundations-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j6_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: Your Recovery Foundation", body: "You've built your understanding of addiction science, coping tools, support systems, and progress tracking. This capstone brings it together. Your recovery is real — and it starts here." },
    { type: "MULTIPLE_CHOICE", order: 2, prompt: "What does 'addiction is a brain disease' mean for how we should treat people in recovery?", choicesJson: JSON.stringify(["They are weak and should just try harder", "They need medical and psychological support, not just willpower", "They should be punished until they stop", "Only certain people can recover"]), answerJson: JSON.stringify("They need medical and psychological support, not just willpower"), explain: "Understanding addiction as a brain disease removes shame and opens the door to real treatment. This is the science." },
    { type: "SCENARIO", order: 3, prompt: "Scenario: You have a craving at 11pm and your sponsor isn't answering.", body: "What do you do?", choicesJson: JSON.stringify(["Use — there's no support available", "Use your HALT check, a grounding technique, and text another support person or crisis line", "Wait and hope it passes without doing anything", "Leave the house to find the substance"]), answerJson: JSON.stringify("Use your HALT check, a grounding technique, and text another support person or crisis line"), explain: "Your toolbox has multiple tools. When one contact is unavailable, use a technique AND try another contact." },
    { type: "TRUE_FALSE", order: 4, prompt: "Cumulative tracking (total good days) is more shame-resistant than streak-based tracking.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "Slips don't erase progress with cumulative tracking. 28 good days out of 30 is still 28 wins." },
    { type: "INFO", order: 5, prompt: "Mission: Your Recovery Blueprint", body: "Write your: 3 triggers, 3 coping tools, 3 support contacts, and 1 progress metric you'll track. This is your Recovery Blueprint — keep it somewhere you can see it." },
  ]);
  ...
  const l7_1_1 = await upsertLesson({ moduleId: unit7_1.id, title: "Harm Reduction Mindset", slug: "harm-reduction-mindset", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_1_2 = await upsertLesson({ moduleId: unit7_1.id, title: "Overdose Basics", slug: "overdose-basics", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_1_3 = await upsertLesson({ moduleId: unit7_1.id, title: "Naloxone Basics", slug: "naloxone-basics", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_1_4 = await upsertLesson({ moduleId: unit7_1.id, title: "Calling for Help", slug: "calling-for-help", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_1_5 = await upsertLesson({ moduleId: unit7_1.id, title: "Recovery Position", slug: "recovery-position", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_2_1 = await upsertLesson({ moduleId: unit7_2.id, title: "Mixing Risks", slug: "mixing-risks", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_2_2 = await upsertLesson({ moduleId: unit7_2.id, title: "Using Alone", slug: "using-alone", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_2_3 = await upsertLesson({ moduleId: unit7_2.id, title: "Tolerance Changes", slug: "tolerance-changes", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_2_4 = await upsertLesson({ moduleId: unit7_2.id, title: "Party and Social Safety", slug: "party-social-safety", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_2_5 = await upsertLesson({ moduleId: unit7_2.id, title: "After an Overdose Event", slug: "after-overdose", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_3_1 = await upsertLesson({ moduleId: unit7_3.id, title: "Sleep and Nutrition for Stability", slug: "sleep-nutrition-stability", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_3_2 = await upsertLesson({ moduleId: unit7_3.id, title: "Wound and Infection Awareness", slug: "wound-infection-awareness", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_3_3 = await upsertLesson({ moduleId: unit7_3.id, title: "Mental Health and Risk", slug: "mental-health-risk", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_3_4 = await upsertLesson({ moduleId: unit7_3.id, title: "Safer Sex and Consent", slug: "safer-sex-consent", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l7_3_5 = await upsertLesson({ moduleId: unit7_3.id, title: "Avoiding Scams and Exploitation", slug: "avoiding-exploitation", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit7_cap = await upsertModule({ pathId: journey7.id, title: "Harm Reduction Capstone", slug: "harm-reduction-capstone", order: 4 });
  const j7_capstone = await upsertLesson({ moduleId: unit7_cap.id, title: "Harm Reduction: Final Challenge", slug: "harm-reduction-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j7_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: Protecting Yourself and Others", body: "You've learned overdose response, safer use practices, disease prevention, and how to spot exploitation. This capstone brings it all together. Harm reduction saves lives — yours and others." },
    { type: "MULTIPLE_CHOICE", order: 2, prompt: "You find someone unresponsive and suspect an overdose. What's the correct order of steps?", choicesJson: JSON.stringify(["Wait and see", "Call 911, give naloxone if available, perform rescue breathing, stay with them", "Give naloxone and leave", "Shake them hard and drive them to the hospital"]), answerJson: JSON.stringify("Call 911, give naloxone if available, perform rescue breathing, stay with them"), explain: "Call 911 first — then naloxone + rescue breathing. Stay until help arrives. Good Samaritan laws protect you." },
    { type: "TRUE_FALSE", order: 3, prompt: "Never use alone is one of the most effective overdose prevention strategies.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "Having someone present — or using the Never Use Alone hotline — means someone can help if you stop breathing." },
    { type: "SCENARIO", order: 4, prompt: "Scenario: Someone offers you 'free' drugs in exchange for a favor you're uncomfortable with.", body: "What's the safest response?", choicesJson: JSON.stringify(["Accept — it's free", "Decline — this is exploitation. Connect with a harm reduction center for free supplies and support instead", "Ask for more details first", "It depends on the favor"]), answerJson: JSON.stringify("Decline — this is exploitation. Connect with a harm reduction center for free supplies and support instead"), explain: "Harm reduction services provide free supplies and support without strings attached. Never trade safety for substances." },
    { type: "INFO", order: 5, prompt: "Mission: Your Harm Reduction Kit", body: "Identify 3 harm reduction tools you have access to (naloxone, clean supplies, Never Use Alone hotline, etc.). Write down where you can get them. Your kit can save lives — including your own." },
  ]);
  ...
  const l8_1_1 = await upsertLesson({ moduleId: unit8_1.id, title: "Levels of Care 101", slug: "levels-of-care", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_1_2 = await upsertLesson({ moduleId: unit8_1.id, title: "What a First Appointment Looks Like", slug: "first-appointment", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_1_3 = await upsertLesson({ moduleId: unit8_1.id, title: "Confidentiality Basics", slug: "confidentiality-basics", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_1_4 = await upsertLesson({ moduleId: unit8_1.id, title: "Support Groups Overview", slug: "support-groups-overview", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_1_5 = await upsertLesson({ moduleId: unit8_1.id, title: "Recovery Coaching and Case Management", slug: "recovery-coaching", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_2_1 = await upsertLesson({ moduleId: unit8_2.id, title: "Finding Local Help", slug: "finding-local-help", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_2_2 = await upsertLesson({ moduleId: unit8_2.id, title: "Insurance and No-Insurance Paths", slug: "insurance-paths", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_2_3 = await upsertLesson({ moduleId: unit8_2.id, title: "Paperwork Without Panic", slug: "paperwork-without-panic", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_2_4 = await upsertLesson({ moduleId: unit8_2.id, title: "Transportation and Scheduling", slug: "transportation-scheduling", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_2_5 = await upsertLesson({ moduleId: unit8_2.id, title: "Advocacy Skills", slug: "advocacy-skills", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_3_1 = await upsertLesson({ moduleId: unit8_3.id, title: "Early Recovery Routine", slug: "early-recovery-routine", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_3_2 = await upsertLesson({ moduleId: unit8_3.id, title: "Handling Cravings in Treatment", slug: "cravings-in-treatment", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_3_3 = await upsertLesson({ moduleId: unit8_3.id, title: "Dealing With Shame and Setbacks", slug: "shame-and-setbacks", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_3_4 = await upsertLesson({ moduleId: unit8_3.id, title: "Family and Relationship Pressure", slug: "family-pressure", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_3_5 = await upsertLesson({ moduleId: unit8_3.id, title: "Planning Weekends and Triggers", slug: "planning-weekends", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_4_1 = await upsertLesson({ moduleId: unit8_4.id, title: "Work and Recovery Balance", slug: "work-recovery-balance", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_4_2 = await upsertLesson({ moduleId: unit8_4.id, title: "Sober Social Life", slug: "sober-social-life", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_4_3 = await upsertLesson({ moduleId: unit8_4.id, title: "Money Repair Plan", slug: "money-repair-plan", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_4_4 = await upsertLesson({ moduleId: unit8_4.id, title: "Health Follow-Up", slug: "health-follow-up", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l8_4_5 = await upsertLesson({ moduleId: unit8_4.id, title: "Giving Back Without Burnout", slug: "giving-back", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit8_cap = await upsertModule({ pathId: journey8.id, title: "Treatment Navigation Capstone", slug: "treatment-navigation-capstone", order: 5 });
  const j8_capstone = await upsertLesson({ moduleId: unit8_cap.id, title: "Treatment Navigation: Final Challenge", slug: "treatment-navigation-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j8_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: Your Treatment Toolkit", body: "You've navigated treatment types, medication-assisted treatment, mental health connections, and post-treatment life. This capstone tests your ability to apply that knowledge when it matters most." },
    { type: "SCENARIO", order: 2, prompt: "Scenario: Your treatment program ends next month and you don't have an aftercare plan.", body: "What's your first step?", choicesJson: JSON.stringify(["Hope for the best", "Ask your counselor now about step-down programs, sober living options, and outpatient follow-up", "Stop treatment early to save money", "Wait until the last day to start looking"]), answerJson: JSON.stringify("Ask your counselor now about step-down programs, sober living options, and outpatient follow-up"), explain: "The transition out of treatment is one of the highest-risk periods. Planning early prevents crisis." },
    { type: "MULTIPLE_CHOICE", order: 3, prompt: "MAT (Medication-Assisted Treatment) works best when combined with:", choicesJson: JSON.stringify(["Nothing else — the medication is enough", "Counseling and peer support", "Isolation and rest", "Rapid detox only"]), answerJson: JSON.stringify("Counseling and peer support"), explain: "MAT treats the physical side of addiction. Counseling and community treat the behavioral and emotional sides. Together they work best." },
    { type: "TRUE_FALSE", order: 4, prompt: "Preventive health care should be part of your recovery plan, not just crisis response.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "Recovery is a full-body process. Regular check-ups catch problems early and support long-term wellness." },
    { type: "INFO", order: 5, prompt: "Mission: Build Your Aftercare Plan", body: "Write out your aftercare plan: step-down program or outpatient follow-up, 2 peer support contacts, 1 mental health resource, and your health care provider. This plan is your safety net after treatment ends." },
  ]);
  ...
  const l9_1_1 = await upsertLesson({ moduleId: unit9_1.id, title: "The Relapse Road", slug: "relapse-road", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_1_2 = await upsertLesson({ moduleId: unit9_1.id, title: "Warning Signs", slug: "warning-signs", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_1_3 = await upsertLesson({ moduleId: unit9_1.id, title: "The 3-Choice Rule (Pause, Reach, Replace)", slug: "three-choice-rule", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_1_4 = await upsertLesson({ moduleId: unit9_1.id, title: "Recovery Scripts", slug: "recovery-scripts", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_1_5 = await upsertLesson({ moduleId: unit9_1.id, title: "Lapse vs Relapse (Recover Fast)", slug: "lapse-vs-relapse", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_2_1 = await upsertLesson({ moduleId: unit9_2.id, title: "People Boundaries", slug: "people-boundaries", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_2_2 = await upsertLesson({ moduleId: unit9_2.id, title: "Places Plan", slug: "places-plan", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_2_3 = await upsertLesson({ moduleId: unit9_2.id, title: "Phone and Social Media Triggers", slug: "phone-social-triggers", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_2_4 = await upsertLesson({ moduleId: unit9_2.id, title: "Money Triggers", slug: "money-triggers", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_2_5 = await upsertLesson({ moduleId: unit9_2.id, title: "Holidays and Anniversaries", slug: "holidays-anniversaries", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_3_1 = await upsertLesson({ moduleId: unit9_3.id, title: "Anger Management", slug: "anger-management", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_3_2 = await upsertLesson({ moduleId: unit9_3.id, title: "Loneliness", slug: "loneliness-recovery", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_3_3 = await upsertLesson({ moduleId: unit9_3.id, title: "Grief", slug: "grief-recovery", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_3_4 = await upsertLesson({ moduleId: unit9_3.id, title: "Anxiety", slug: "anxiety-recovery", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_3_5 = await upsertLesson({ moduleId: unit9_3.id, title: "Depression-Like Days", slug: "depression-days", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_4_1 = await upsertLesson({ moduleId: unit9_4.id, title: "Routine That Protects You", slug: "protective-routine", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_4_2 = await upsertLesson({ moduleId: unit9_4.id, title: "Meaning and Purpose", slug: "meaning-purpose", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_4_3 = await upsertLesson({ moduleId: unit9_4.id, title: "Repairing Relationships", slug: "repairing-relationships", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_4_4 = await upsertLesson({ moduleId: unit9_4.id, title: "Handling Success Without Sabotage", slug: "success-without-sabotage", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l9_4_5 = await upsertLesson({ moduleId: unit9_4.id, title: "Recovery Identity", slug: "recovery-identity", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit9_cap = await upsertModule({ pathId: journey9.id, title: "Relapse Prevention Capstone", slug: "relapse-prevention-capstone", order: 5 });
  const j9_capstone = await upsertLesson({ moduleId: unit9_cap.id, title: "Relapse Prevention: Final Challenge", slug: "relapse-prevention-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j9_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: Mastering Your Recovery", body: "You've built your understanding of triggers, warning signs, coping strategies, and recovery identity. This final challenge tests your ability to navigate the real moments that test your recovery." },
    { type: "SCENARIO", order: 2, prompt: "Scenario: Things are going really well. You've been clean 6 months. You think 'I can probably handle being around it now.'", body: "What's happening, and what should you do?", choicesJson: JSON.stringify(["This is true — you've earned it", "This is 'overconfidence' — a known trigger. Call your support person and revisit your relapse prevention plan", "Test it to be sure", "Stop going to meetings since you're clearly cured"]), answerJson: JSON.stringify("This is 'overconfidence' — a known trigger. Call your support person and revisit your relapse prevention plan"), explain: "Overconfidence is one of the sneakiest triggers. The 'I can handle it now' thought is itself a warning sign." },
    { type: "MULTIPLE_CHOICE", order: 3, prompt: "Your relapse prevention plan should include:", choicesJson: JSON.stringify(["Only your sobriety goal", "Triggers, warning signs, coping tools, support contacts, and an emergency plan", "A list of people who believe in you", "Your sponsor's phone number only"]), answerJson: JSON.stringify("Triggers, warning signs, coping tools, support contacts, and an emergency plan"), explain: "A complete plan covers all the angles — before, during, and after a high-risk moment." },
    { type: "TRUE_FALSE", order: 4, prompt: "Building a recovery identity around your values and roles (not just sobriety) makes recovery more sustainable.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "When your identity is bigger than your recovery, you have more reasons to protect it." },
    { type: "INFO", order: 5, prompt: "Mission: Your Complete Relapse Prevention Plan", body: "Write your full plan: 5 triggers, 3 warning signs, 5 coping tools, 3 support contacts, and 1 emergency plan. Review it monthly and update it as you grow. This is your recovery armor." },
  ]);
  ...
  const l10_1_1 = await upsertLesson({ moduleId: unit10_1.id, title: "Alcohol and Your Body", slug: "alcohol-body", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_1_2 = await upsertLesson({ moduleId: unit10_1.id, title: "Drinking Triggers and Replacements", slug: "drinking-triggers", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_1_3 = await upsertLesson({ moduleId: unit10_1.id, title: "Social Pressure and Scripts", slug: "alcohol-social-pressure", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_1_4 = await upsertLesson({ moduleId: unit10_1.id, title: "Sleep, Anxiety, and the Alcohol Cycle", slug: "alcohol-sleep-anxiety", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_1_5 = await upsertLesson({ moduleId: unit10_1.id, title: "Alcohol Relapse Prevention", slug: "alcohol-relapse-prevention", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_2_1 = await upsertLesson({ moduleId: unit10_2.id, title: "Opioid Overdose Risk", slug: "opioid-overdose-risk", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_2_2 = await upsertLesson({ moduleId: unit10_2.id, title: "Treatment Options Including MOUD", slug: "moud-treatment", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_2_3 = await upsertLesson({ moduleId: unit10_2.id, title: "Cravings, Pain, and Alternatives", slug: "opioid-cravings-pain", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_2_4 = await upsertLesson({ moduleId: unit10_2.id, title: "Recovery Supports and Re-Entry", slug: "opioid-recovery-supports", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_2_5 = await upsertLesson({ moduleId: unit10_2.id, title: "Long-Term Opioid Recovery", slug: "long-term-opioid-recovery", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_3_1 = await upsertLesson({ moduleId: unit10_3.id, title: "The Sleep Deprivation Spiral", slug: "sleep-deprivation-spiral", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_3_2 = await upsertLesson({ moduleId: unit10_3.id, title: "Crash Days Recovery", slug: "crash-days", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_3_3 = await upsertLesson({ moduleId: unit10_3.id, title: "Triggers and High-Risk Hours", slug: "stimulant-triggers", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_3_4 = await upsertLesson({ moduleId: unit10_3.id, title: "Rebuilding Energy and Confidence", slug: "rebuilding-energy", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l10_3_5 = await upsertLesson({ moduleId: unit10_3.id, title: "Stimulant Relapse Prevention", slug: "stimulant-relapse-prevention", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit10_cap = await upsertModule({ pathId: journey10.id, title: "Substance Safety Capstone", slug: "substance-safety-capstone", order: 4 });
  const j10_capstone = await upsertLesson({ moduleId: unit10_cap.id, title: "Substance Safety: Final Challenge", slug: "substance-safety-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j10_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: Substance-Specific Safety", body: "Every substance has its own biology, risks, and recovery path. You've learned what you're dealing with specifically — and that knowledge is power. This capstone brings alcohol, opioid, and stimulant knowledge together." },
    { type: "MULTIPLE_CHOICE", order: 2, prompt: "Why is alcohol withdrawal potentially more dangerous than opioid withdrawal?", choicesJson: JSON.stringify(["It isn't — opioid withdrawal is more dangerous", "Alcohol withdrawal can cause seizures and death; medical supervision is often needed", "Alcohol withdrawal is shorter so it's less risky", "Neither requires medical attention"]), answerJson: JSON.stringify("Alcohol withdrawal can cause seizures and death; medical supervision is often needed"), explain: "Severe alcohol withdrawal (delirium tremens) can be fatal. Always consult a healthcare provider before stopping heavy, chronic alcohol use." },
    { type: "SCENARIO", order: 3, prompt: "Scenario: You're in stimulant recovery and a friend invites you to an all-night party 'just to socialize.'", body: "What's the safest response?", choicesJson: JSON.stringify(["Go — you can handle it", "Decline or suggest meeting for coffee instead; late-night unstructured environments are high-risk for stimulant recovery", "Go but leave early", "It's fine as long as you don't use"]), answerJson: JSON.stringify("Decline or suggest meeting for coffee instead; late-night unstructured environments are high-risk for stimulant recovery"), explain: "High-risk environments don't need to be avoided forever, but early recovery is not the time to test your limits in them." },
    { type: "TRUE_FALSE", order: 4, prompt: "Fentanyl can now be found in drugs other than opioids, making fentanyl test strips important for any substance user.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "Fentanyl contamination is now found in stimulants, pressed pills, and other substances. Test strips save lives regardless of your substance." },
    { type: "INFO", order: 5, prompt: "Mission: Your Substance-Specific Safety Card", body: "Write your: 1) Substance, 2) Top 3 physical risks, 3) Top 3 withdrawal signs to watch for, 4) 2 harm reduction tools you have access to. Carry this knowledge with you." },
  ]);
  ...
  const l11_1_1 = await upsertLesson({ moduleId: unit11_1.id, title: "Addiction Basics for Supporters", slug: "addiction-basics-supporters", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_1_2 = await upsertLesson({ moduleId: unit11_1.id, title: "What Helps vs What Harms", slug: "helps-vs-harms", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_1_3 = await upsertLesson({ moduleId: unit11_1.id, title: "Shame vs Accountability", slug: "shame-vs-accountability", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_1_4 = await upsertLesson({ moduleId: unit11_1.id, title: "Talking Without Escalation", slug: "talking-without-escalation", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_1_5 = await upsertLesson({ moduleId: unit11_1.id, title: "Safety Planning for Supporters", slug: "supporter-safety", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_2_1 = await upsertLesson({ moduleId: unit11_2.id, title: "Boundary Scripts for Supporters", slug: "supporter-boundary-scripts", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_2_2 = await upsertLesson({ moduleId: unit11_2.id, title: "Money and Housing Boundaries", slug: "money-housing-boundaries", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_2_3 = await upsertLesson({ moduleId: unit11_2.id, title: "Kids and Family Safety", slug: "kids-family-safety", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_2_4 = await upsertLesson({ moduleId: unit11_2.id, title: "Crisis Calls as a Supporter", slug: "supporter-crisis-calls", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_2_5 = await upsertLesson({ moduleId: unit11_2.id, title: "After a Setback (For Supporters)", slug: "supporter-after-setback", order: 5, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_3_1 = await upsertLesson({ moduleId: unit11_3.id, title: "Treatment Options for Supporters", slug: "treatment-options-supporters", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_3_2 = await upsertLesson({ moduleId: unit11_3.id, title: "Appointment Prep for Supporters", slug: "appointment-prep-supporters", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_3_3 = await upsertLesson({ moduleId: unit11_3.id, title: "Follow-Up and Encouragement", slug: "followup-encouragement", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_3_4 = await upsertLesson({ moduleId: unit11_3.id, title: "Support Groups for Families", slug: "family-support-groups", order: 4, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_4_1 = await upsertLesson({ moduleId: unit11_4.id, title: "Burnout Prevention", slug: "supporter-burnout", order: 1, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_4_2 = await upsertLesson({ moduleId: unit11_4.id, title: "Guilt and Grief for Supporters", slug: "supporter-guilt-grief", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_4_3 = await upsertLesson({ moduleId: unit11_4.id, title: "Building Your Own Support Team", slug: "own-support-team", order: 2, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const l11_4_4 = await upsertLesson({ moduleId: unit11_4.id, title: "Your Long-Term Plan", slug: "supporter-long-term", order: 3, xpReward: 2, lessonType: "learn", estimatedMinutes: 5 });
  ...
  const unit11_cap = await upsertModule({ pathId: journey11.id, title: "Supporter Skills Capstone", slug: "supporter-skills-capstone", order: 5 });
  const j11_capstone = await upsertLesson({ moduleId: unit11_cap.id, title: "Supporter & Family Skills: Final Challenge", slug: "supporter-family-capstone-lesson", order: 1, xpReward: 25, lessonType: "capstone", estimatedMinutes: 15 });
  await seedCards(j11_capstone.id, [
    { type: "INFO", order: 1, prompt: "Capstone: The Art of Sustainable Support", body: "You've learned addiction science, boundaries, communication, how to help someone get help, and how to care for yourself while doing it. This capstone brings it all together. You can't pour from an empty cup — but a full one changes everything." },
    { type: "SCENARIO", order: 2, prompt: "Scenario: Your loved one relapses after 4 months of sobriety. You feel devastated and angry.", body: "What's the healthiest immediate response?", choicesJson: JSON.stringify(["Cut off contact permanently", "Take time to process your feelings, then come back with compassion — relapse is part of many recovery journeys, not the end", "Give them an ultimatum immediately", "Blame yourself for not doing enough"]), answerJson: JSON.stringify("Take time to process your feelings, then come back with compassion — relapse is part of many recovery journeys, not the end"), explain: "Your feelings are valid. And so is the fact that relapse doesn't erase progress. Process first, respond second." },
    { type: "MULTIPLE_CHOICE", order: 3, prompt: "What's the difference between enabling and supporting?", choicesJson: JSON.stringify(["There is no difference", "Enabling removes consequences; supporting provides resources, accountability, and compassion", "Supporting means giving them whatever they need", "Enabling is fine if you do it out of love"]), answerJson: JSON.stringify("Enabling removes consequences; supporting provides resources, accountability, and compassion"), explain: "Love without accountability enables. Love with boundaries and resources supports. Know the difference." },
    { type: "TRUE_FALSE", order: 4, prompt: "Supporters who practice self-care and maintain boundaries are better able to sustain their support over time.", choicesJson: JSON.stringify(["True", "False"]), answerJson: JSON.stringify("True"), explain: "You can't run a marathon on empty. Self-care isn't selfish — it's what makes sustainable support possible." },
    { type: "INFO", order: 5, prompt: "Mission: Your Supporter Plan", body: "Write: 2 boundaries you're committed to, 1 supportive action you'll take this week, 1 self-care practice you'll protect, and 1 resource you'll share with your loved one. You've done the work — now live it." },
  ]);
